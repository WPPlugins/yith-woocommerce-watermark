    ...
    class YITH_WC_Watermark
    {
        ...
        public function admin_enqueue_free_scripts()
        {
            ...
            if( isset( $post ) && get_post_type( $post ) == 'product' ) {
                ...
                wp_register_script( 'ywcwat_product_admin_script', YWCWAT_ASSETS_URL . 'js/ywcwat_admin_single_product' . $this->_suffix . '.js', array( 'jquery' ), YWCWAT_VERSION, true );
         ...
         * @since 1.1.0
         */
        public function apply_all_watermark( $attach_id )
        {
            ...
            $all_watermarks = apply_filters( 'ywcwat_watermarks_to_apply', get_option( 'ywcwat_watermark_select' ), $attach_id );
        ...
        public function save_watermark_on_single_product()
        {
            ...
            if( $product ) {
                ...
                $attach_ids = apply_filters( 'ywcwat_product_attach_ids', $attach_ids, $product_id );
                $results = array();
